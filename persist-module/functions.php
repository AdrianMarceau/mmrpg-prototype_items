...
$functions = array(
    ...
    'rpg-robot_check-items_pre-check-health' => function($objects){
        //error_log('rpg-robot_check-items_pre-check-health() for '.$objects['this_robot']->robot_string.'//'.$objects['this_item']->item_token);
    ...
    'rpg-robot_check-items_end-of-turn' => function($objects){
        //error_log('rpg-robot_check-items_end-of-turn() for '.$objects['this_robot']->robot_string.'//'.$objects['this_item']->item_token);
    ...
    'rpg-ability_trigger-damage_pre-damage' => function($objects){
        //error_log('rpg-ability_trigger-damage_pre-damage() for '.$objects['this_robot']->robot_string.'//'.$objects['this_item']->item_token);
    ...
    'rpg-ability_trigger-damage_after' => function($objects){
        ...
        // If this robot is not the recipient, the item doesn't activate
        if ($options->damage_target !== $this_robot){ return false; }
        ...
        $this_battle->events_create($this_robot, false, $this_robot->robot_name.'\'s '.$this_item->item_name,
            ...
            'The item protects '.$this_robot->get_pronoun('object').' from being disabled by a OHKO!',
            array(
                'this_item' => $this_item,
...
$functions['rpg-robot_check-items_battle-start'] = function($objects) use ($functions){
    return $functions['rpg-robot_check-items_pre-check-health']($objects, true);
};
...
$functions['rpg-battle_switch-in_after'] = function($objects) use ($functions){
    return $functions['rpg-robot_check-items_pre-check-health']($objects, false);
};
?>
